% l/vlPAG Post Sucrose Consumption
% 06/16/2025


cd('/Users/nitishpatel/Library/CloudStorage/Box-Box/');

ch_on_off = readmatrix('PAG_VGAT_Feeding.xlsx','Sheet','Fig3_RevalueChow_DevalueSacchar','Range','M166:M171');
yfp_on_off = readmatrix('PAG_VGAT_Feeding.xlsx','Sheet','Fig3_RevalueChow_DevalueSacchar','Range','M181:M186');
...
ylabel({'\Delta sucrose weight (mg)'; '(ON-OFF)'}, 'FontSize', 24);
