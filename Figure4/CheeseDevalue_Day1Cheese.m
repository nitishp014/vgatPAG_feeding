% l/vlPAG Devaluing Cheese vs Chocolate Day 1 Consumption (Cheese)
% 05/17/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_offS = readmatrix('vgat_wnt_test.xlsx','Sheet','cheese','Range','M46:M53');
yfp_on_offS = readmatrix('vgat_wnt_test.xlsx','Sheet','cheese','Range','M65:M72');
...
%text(0.24, 309, ['p = ' num2str(p, 2)], 'HorizontalAlignment', 'center', 'FontSize', 20); % n = 10 each group
