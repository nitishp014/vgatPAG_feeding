% l/vlPAG Devaluing Cheese vs Chocolate Day 2 Consumption (Choc)
% 05/17/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','chocolate','Range','M80:M87');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','chocolate','Range','M99:M106');
...
%text(0.24, 359, ['p = ' num2str(p, 2)], 'HorizontalAlignment', 'center', 'FontSize', 20); % n = 10 each groupo
