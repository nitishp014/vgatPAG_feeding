% l/vlPAG Pre Sucrose Consumption
% 06/10/2025


cd('/Users/nitishpatel/Library/CloudStorage/Box-Box/');

ch_on_off = readmatrix('PAG_VGAT_Feeding.xlsx','Sheet','Fig3_RevalueChow_DevalueSacchar','Range','M136:M141');
yfp_on_off = readmatrix('PAG_VGAT_Feeding.xlsx','Sheet','Fig3_RevalueChow_DevalueSacchar','Range','M151:M156');
