% l/vlPAG Devaluing Choc vs Cheese Day 2 Consumption (Choc)
% 05/24/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','chocolate','Range','M161:M167');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','chocolate','Range','M180:M186');
...
%text(0.24, 465, 'n.s.', 'HorizontalAlignment', 'center', 'FontSize', 20); % adds significant asterisk
%text(0.24, 309, ['p = ' num2str(p, 2)], 'HorizontalAlignment', 'center', 'FontSize', 20); % n = 10 each groupo
%text(0.24, 480, '_____', 'HorizontalAlignment', 'center', 'FontSize', 40);
