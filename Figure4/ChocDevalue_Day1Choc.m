% l/vlPAG Devaluing Chocolate vs Cheese Day 1 Consumption (Chocolate)
% 05/24/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','chocolate','Range','M121:M127'); % Omitted C8 bc didn't eat in either on or off
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','chocolate','Range','M140:M146'); % Omitted Y8
