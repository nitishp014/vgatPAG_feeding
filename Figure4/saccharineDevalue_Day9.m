% l/vlPAG Post Saccharine Consumption
% 0/15/2024


cd('/Users/nitishpatel/Library/CloudStorage/Box-Box/');

ch_on_off = readmatrix('PAG_VGAT_Feeding.xlsx','Sheet','Fig3_RevalueChow_DevalueSacchar','Range','M106:M112');
yfp_on_off = readmatrix('PAG_VGAT_Feeding.xlsx','Sheet','Fig3_RevalueChow_DevalueSacchar','Range','M121:M126');
