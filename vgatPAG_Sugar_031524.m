% l/vlPAG Sugar Consumption
% 03/15/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','sugar','Range','M4:M11');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','sugar','Range','M22:M29');
...
ylabel({'\Delta sugar weight (mg)'; '(ON-OFF)'}, 'FontSize', 24);
