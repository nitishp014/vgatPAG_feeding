% l/vlPAG Sausage Consumption
% 03/02/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','sausage','Range','M4:M11');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','sausage','Range','M30:M37');
...
ylabel({'\Delta sausage weight (mg)'; '(ON-OFF)'}, 'FontSize', 24);
