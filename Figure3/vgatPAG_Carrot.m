% l/vlPAG AAV5 Carrot Consumption
% 05/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','carrots','Range','M99:M106');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','carrots','Range','M117:M124');
...
ylabel({'\Delta carrot weight (mg)'; '(ON-OFF)'}, 'FontSize', 24);
