% l/vlPAG Cheese Consumption
% 01/26/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','cheese','Range','M6:M15');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','cheese','Range','M24:M33');
