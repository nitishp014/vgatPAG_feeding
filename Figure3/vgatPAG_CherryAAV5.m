% l/vlPAG AAV5 Cherry Consumption
% 05/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','cherry','Range','M44:M51');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','cherry','Range','M63:M70');
...
ylabel({'\Delta dried cherry weight (mg)'; '(ON-OFF)'}, 'FontSize', 24);
