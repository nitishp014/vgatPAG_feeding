% l/vlPAG AAV5 Pepper Consumption
% 05/2024


cd('/Users/nitishpatel/Documents/MATLAB/');

ch_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','pepper','Range','M4:M11');
yfp_on_off = readmatrix('vgat_wnt_test.xlsx','Sheet','pepper','Range','M22:M29');
...
ylabel({'\Delta pepper weight (mg)'; '(ON-OFF)'}, 'FontSize', 24);
